    ...
    <div className="container mx-auto max-w-4xl py-12 px-4 md:py-20">
      <div className="flex flex-col items-center text-center mb-12">
        <Avatar className="h-40 w-40 mb-6 border-4 border-primary shadow-lg">
            <AvatarImage src="https://unsplash.com/photos/i57HjPUr2bgq=80&w=1000&auto=format&fit=crop" alt="Investment Advisor" data-ai-hint="professional headshot" className="object-cover"/>
